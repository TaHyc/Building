...
return  (
	...
	<div className={cl.header}>
		...
		<img className={cl.kub} src={kub}/><div className={cl.zakaz}>Заказать 3D-макет дома</div>
		<div className={cl.phone}><img className={cl.phoneLogo} src={phone}/>
	...
	<a href='https://t.me/AquaTechnology_bot'><img className={cl.cont}src={ws}/></a></div></div></div>
